...
GO
ALTER TABLE dbo.STOK WITH NOCHECK
  ADD CONSTRAINT FK_STOK_BIRIMID FOREIGN KEY (BIRIMID) REFERENCES dbo.T_BIRIM (ID)
GO

--
-- Disable foreign key [FK_STOK_BIRIMID] on table [dbo].[STOK]
--
PRINT (N'Disable foreign key [FK_STOK_BIRIMID] on table [dbo].[STOK]')
GO
ALTER TABLE dbo.STOK
  NOCHECK CONSTRAINT FK_STOK_BIRIMID
GO
...
--
-- Disable foreign key [FK_STOK_GRUPID] on table [dbo].[STOK]
--
PRINT (N'Disable foreign key [FK_STOK_GRUPID] on table [dbo].[STOK]')
GO
ALTER TABLE dbo.STOK
  NOCHECK CONSTRAINT FK_STOK_GRUPID
GO
...
--
-- Disable foreign key [FK_STOK_MARKAID] on table [dbo].[STOK]
--
PRINT (N'Disable foreign key [FK_STOK_MARKAID] on table [dbo].[STOK]')
GO
ALTER TABLE dbo.STOK
  NOCHECK CONSTRAINT FK_STOK_MARKAID
GO
...
--
-- Disable foreign key [FK_STOK_REYONRAFID] on table [dbo].[STOK]
--
PRINT (N'Disable foreign key [FK_STOK_REYONRAFID] on table [dbo].[STOK]')
GO
ALTER TABLE dbo.STOK
  NOCHECK CONSTRAINT FK_STOK_REYONRAFID
GO
...
GO
ALTER TABLE dbo.STOK_H WITH NOCHECK
  ADD CONSTRAINT FK_STOK_H_STOKID FOREIGN KEY (STOKID) REFERENCES dbo.STOK (ID)
GO

--
-- Disable foreign key [FK_STOK_H_STOKID] on table [dbo].[STOK_H]
--
PRINT (N'Disable foreign key [FK_STOK_H_STOKID] on table [dbo].[STOK_H]')
GO
ALTER TABLE dbo.STOK_H
  NOCHECK CONSTRAINT FK_STOK_H_STOKID
GO
