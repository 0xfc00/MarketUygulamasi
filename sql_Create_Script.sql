...
CREATE TABLE dbo.POS_H (
  ...
  EVRAKNO nvarchar(20) NULL,
  FATURAID int NULL CONSTRAINT DF_POSKASA_FATURAID DEFAULT (0),
  SATISID int NULL CONSTRAINT DF_POSKASA_SATISLISTID DEFAULT (0),
  POSID int NULL CONSTRAINT DF_POSKASA_POSID DEFAULT (0),
  POSTANIMI nvarchar(30) NULL,
  COMNAMETIME nvarchar(80) NULL,
  UPDATECOUNT int NULL CONSTRAINT DF_POSKASA_UPDATECOUNT DEFAULT (0),
...
CREATE TABLE dbo.KASA_H (
  ...
  ACIKLAMA2 nvarchar(100) NULL,
  ISLEMTURU nvarchar(20) NULL,
  BORC float NULL CONSTRAINT DF_KASA_BORC DEFAULT (0),
  ALACAK float NULL CONSTRAINT DF_KASA_ALACAK DEFAULT (0),
  ...
  AKTIF bit NULL CONSTRAINT DF_dbo_KASA_H_AKTIF DEFAULT (1),
...
--
-- Create foreign key [FK_KASA_H_FATURAID] on table [dbo].[KASA_H]
--
PRINT (N'Create foreign key [FK_KASA_H_FATURAID] on table [dbo].[KASA_H]')
GO
ALTER TABLE dbo.KASA_H
  ADD CONSTRAINT FK_KASA_H_FATURAID FOREIGN KEY (FATURAID) REFERENCES dbo.____FATURA (ID)
GO
