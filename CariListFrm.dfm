object frmCariList: TfrmCariList
  Left = 0
  Top = 0
  Caption = 'frmCariList'
  ClientHeight = 505
  ...
  object ActionList1: TActionList
    Left = 656
    Top = 120
    object acCariDuzenle: TAction
      Caption = 'D'#252'zenle'
      OnExecute = acCariDuzenleExecute
    end
    object acCariKartSil: TAction
      Caption = 'Sil'
      OnExecute = acCariKartSilExecute
    end
    object acCariHarList: TAction
      Caption = 'Cari Hareketleri'
