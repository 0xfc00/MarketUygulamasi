...
uses
  ...
  Vcl.Menus,
  Vcl.ActnList, cxButtons, Vcl.ExtCtrls, FireDAC.Comp.Client,

  Data.DB,
  cxGridCustomTableView, cxGridTableView, cxGridDBTableView,
  cxGridLevel, cxGrid, YeniCariKartFrm, dxSkinsCore, dxSkinBasic, dxSkinBlack,
  ...
  cxClasses, cxGridCustomView, Vcl.StdCtrls;
